...
if __name__ == '__main__':
    ...
    # Train a model
    model = svm.SVC(C=1.0, kernel='linear')                  # TODO #2) Find a better classifier (SVC accuracy: 0.902)
    ...
    conf_disp= metrics.ConfusionMatrixDisplay(conf_matrix, display_labels=['malignant', 'benign'])
    conf_disp.plot()
